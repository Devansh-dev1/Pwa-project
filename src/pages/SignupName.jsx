...
export default function SignupName() {
  ...
  const styles = useMemo(() => ({
    ...
    header: { marginTop: 24 },
    title: { fontSize: 24, letterSpacing: '-0.3px', color: '#2a2a2a',fontWeight: 800 },
    subtitle: { marginTop: 7, color: '#6B7280', fontSize: 14},
    fields: { marginTop: 35 },
    label: (active) => ({ color: active ? '#2A46A8' : '#7EC8C9', fontSize: 14, fontWeight: 'bold' }),
    borderWrap: (active) => ({ marginTop: 5, borderRadius: 24, border: '4px solid', borderColor: active ? '#EFE6FB' : '#eef7f7' }),
    inputRow: (active) => ({ height: 52, borderRadius: 20, border: '1.5px solid', borderColor: active ? '#2A46A8' : '#eef7f7', background: active ? '#fff' : '#eff7f7', display: 'flex', alignItems: 'center', padding: '0 12px', fontWeight: 'bold' }),
    input: { flex: 1, fontSize: 16, border: 'none', outline: 'none', background: 'transparent', color: '#2A46A8', fontWeight: 700 },
    ...
    disabledBtn: { height: 56, width: '100%', borderRadius: 999, border: '1px solid #e5e7eb', background: '#f3f4f6', color: '#9ca3af', cursor: 'not-allowed', fontWeight: 800 },
    loadingBtn: { height: 56, width: '100%', borderRadius: 999, border: 'none', color: '#fff', background: 'linear-gradient(90deg, #6b7280 0%, #4b5563 100%)', cursor: 'not-allowed', opacity: 0.7, fontWeight: 800 },
    ...
    progressBar: { position: 'absolute', top: 0, left: 0, bottom: 0, width: '15%', borderRadius: 10, background: 'linear-gradient(90deg,#B682F7,#D0A7FF)' },
  }), [])
        ...
        <div style={styles.fields}>
          <div>
            ...
            <div style={styles.borderWrap(focused === 'first')}>
              <div  className='AddFontFamily' style={styles.inputRow(focused === 'first')}>
          ...
          <div style={{ marginTop: 25 }}>
            ...
            <div style={styles.borderWrap(focused === 'middle')}>
              <div className='AddFontFamily' style={styles.inputRow(focused === 'middle')}>
          ...
          <div style={{ marginTop: 25 }}>
            ...
            <div style={styles.borderWrap(focused === 'last')}>
              <div  className='AddFontFamily' style={styles.inputRow(focused === 'last')}>
