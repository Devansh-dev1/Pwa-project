...
export default function SignupVerify() {
  ...
  const styles = useMemo(() => ({
    ...
    input: { flex: 1, fontSize: 16, border: 'none', outline: 'none', background: 'transparent', color: '#413c3a', fontFamily: 'Nunito-Medium, sans-serif', letterSpacing: 4, textAlign: 'center' },
